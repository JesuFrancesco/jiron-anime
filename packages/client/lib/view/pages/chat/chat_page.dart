...
import 'package:jiron_anime/viewmodel/controllers/message_controller.dart';
      ...
      body: CustomLayout(
        child: Column(
          children: [
            ...
            Text(mercado.name!, style: Theme.of(context).textTheme.titleSmall),
            // CHAT MESSAGES
            FutureBuilder<void>(
                    ...
                    () => Expanded(
                      child:
                          messageController.isLoading.value
                              ...
                              ? Center(
                                child: Text(
                                  "Empieza tu chat con ${mercado.name!}",
                                ),
                              )
                              : ListView.builder(
                            ...
                            if (messageControllerInput.text.isNotEmpty ||
                              ...
                              messageController.enviarMensaje(
                                LocalMessage(
                                  ...
                                  images:
                                      messageController.selectedImages.toList(),
                                ),
                              );
