...
import 'package:jiron_anime/viewmodel/controllers/events/create_event_controller.dart';

class CreateEventPage extends StatelessWidget {
  CreateEventPage({super.key});
  late final CreateEventController c = Get.put(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              onChanged:
                                  (v) =>
                                      c.duration.value = int.tryParse(v) ?? 0,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              onChanged:
                                  (v) =>
                                      c.capacity.value = int.tryParse(v) ?? 0,
                              keyboardType: TextInputType.number,
                              decoration: const InputDecoration(
                                hintText: 'Ej. 200',
                                border: OutlineInputBorder(),
